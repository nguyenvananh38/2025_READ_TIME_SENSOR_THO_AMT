...
Company : VART
Comments: update modbus RTU so vs v1.0
...
//            send("ghi suscess");
        ...
        if(IN1 == OFF && chuTrinhMay1 == OFF) 
        {
            ...
            {    
                if (realTimeIn1.second >= realTimeOut1.second)
                    timeThaoTac1.second = realTimeIn1.second - realTimeOut1.second; 
                else 
                {
                    timeThaoTac1.second = realTimeIn1.second + 60 - realTimeOut1.second;
                    realTimeIn1.minute = realTimeIn1.minute - 1;  
                }
                if (realTimeIn1.minute >= realTimeOut1.minute)
                    timeThaoTac1.minute = realTimeIn1.minute - realTimeOut1.minute; 
                else 
                {
                    timeThaoTac1.minute = realTimeIn1.minute + 60 - realTimeOut1.minute;
                    realTimeIn1.hour = realTimeIn1.hour - 1;  
                } 
                if (realTimeIn1.hour >= realTimeOut1.hour)
                    timeThaoTac1.hour = realTimeIn1.hour - realTimeOut1.hour; 
                else 
                {
                    timeThaoTac1.hour = realTimeIn1.hour + 24 - realTimeOut1.hour;
...
//            delay_ms(200);
        ...
        {  
            timeThaoTac1.hour   = 0;
            timeThaoTac1.minute = 0;
            timeThaoTac1.second = 0;    
