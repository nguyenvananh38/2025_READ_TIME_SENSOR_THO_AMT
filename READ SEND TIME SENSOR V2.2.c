...
Company : VART
Comments: update modbus RTU so vs v2.0   // FINAL CHAY OK VOI FILE HEX DAT TEN V2.3.1  //PHAN CUNG V1.0
update: 
...
#define timeSet   50    //50x100ms  //sau timeSetOn ms thì tính là có tin hieu
...
//            if (address_register1 == 0x15 && chuTrinhMay1 == OFF)
//            { 
//                dataTrans(MAY1);
//                transModbusRTU_dataMay_x(MAY1);
//            }
//            else if (address_register1 == 0x15 && chuTrinhMay1 == ON)
//            {
//                transModbusRTU_dataMay_x(MAY1);
//            }   
//            
//            else if (address_register1 == 0x29 && chuTrinhMay2 == OFF) 
//            { 
//                dataTrans(MAY2);
//                transModbusRTU_dataMay_x(MAY2); 
//            }
//            else if (address_register1 == 0x29 && chuTrinhMay2 == ON) 
//            { 
//                transModbusRTU_dataMay_x(MAY2); 
//            } 
