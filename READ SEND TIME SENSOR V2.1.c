...
Company : VART
Comments: update modbus RTU so vs v2.0
update: 
...
RTC_Time realTimeInX;
RTC_Time realTimeOutX;
RTC_Time timeLuuHoaX;
RTC_Time timeThaoTacX;
...
void dataTrans(unsigned char MAYx)  //can gui data may nao len may 1 hay may 2
{
    if (MAYx == MAY1)
    {
        realTimeInX.hour    =   realTimeIn1.hour;
        realTimeInX.minute  =   realTimeIn1.minute;
        realTimeInX.second  =   realTimeIn1.second;
        realTimeInX.date    =   realTimeIn1.date;
        realTimeInX.month   =   realTimeIn1.month;
        realTimeInX.year    =   realTimeIn1.year; 
        
        realTimeOutX.hour    =   realTimeOut1.hour;
        realTimeOutX.minute  =   realTimeOut1.minute;
        realTimeOutX.second  =   realTimeOut1.second;
        realTimeOutX.date    =   realTimeOut1.date;
        realTimeOutX.month   =   realTimeOut1.month;
        realTimeOutX.year    =   realTimeOut1.year;
          
        timeLuuHoaX.hour    =   timeLuuHoa1.hour;
        timeLuuHoaX.minute  =   timeLuuHoa1.minute;
        timeLuuHoaX.second  =   timeLuuHoa1.second; 
        
        timeThaoTacX.hour   =   timeThaoTac1.hour;
        timeThaoTacX.minute =   timeThaoTac1.minute;
        timeThaoTacX.second =   timeThaoTac1.second;
        
    }
    else if (MAYx == MAY2)
    {
        realTimeInX.hour    =   realTimeIn2.hour;
        realTimeInX.minute  =   realTimeIn2.minute;
        realTimeInX.second  =   realTimeIn2.second;
        realTimeInX.date    =   realTimeIn2.date;
        realTimeInX.month   =   realTimeIn2.month;
        realTimeInX.year    =   realTimeIn2.year;
        
        realTimeOutX.hour    =   realTimeOut2.hour;
        realTimeOutX.minute  =   realTimeOut2.minute;
        realTimeOutX.second  =   realTimeOut2.second;
        realTimeOutX.date    =   realTimeOut2.date;
        realTimeOutX.month   =   realTimeOut2.month;
        realTimeOutX.year    =   realTimeOut2.year;
         
        timeLuuHoaX.hour    =   timeLuuHoa2.hour;
        timeLuuHoaX.minute  =   timeLuuHoa2.minute;
        timeLuuHoaX.second  =   timeLuuHoa2.second;
        
        timeThaoTacX.hour   =   timeThaoTac2.hour;
        timeThaoTacX.minute =   timeThaoTac2.minute;
        timeThaoTacX.second =   timeThaoTac2.second;
    }
}

void transModbusRTU_dataMay_x() 
{
    unsigned char i;       
    ...
    buff_tx[3]  = 0x00; 
    buff_tx[4]  = realTimeInX.hour;  
    buff_tx[5]  = 0x00;    
    buff_tx[6]  = realTimeInX.minute;
    buff_tx[7]  = 0x00;         
    buff_tx[8]  = realTimeInX.second; 
    buff_tx[9]  = 0x00;                
    buff_tx[10] = realTimeInX.date;
    buff_tx[11] = 0x00;          
    buff_tx[12] = realTimeInX.month;
    buff_tx[13] = 0x00;                 
    buff_tx[14] = realTimeInX.year;
    
    buff_tx[15] = 0x00;   
    buff_tx[16] = realTimeOutX.hour;
    buff_tx[17] = 0x00;                 
    buff_tx[18] = realTimeOutX.minute;
    buff_tx[19] = 0x00; 
    buff_tx[20] = realTimeOutX.second; 
    buff_tx[21] = 0x00;
    buff_tx[22] = realTimeOutX.date;
    buff_tx[23] = 0x00;
    buff_tx[24] = realTimeOutX.month;
    buff_tx[25] = 0x00;
    buff_tx[26] = realTimeOutX.year; 
     
    buff_tx[27] = 0x00;
    buff_tx[28] = timeLuuHoaX.hour;
    buff_tx[29] = 0x00;
    buff_tx[30] = timeLuuHoaX.minute;  
    buff_tx[31] = 0x00;
    buff_tx[32] = timeLuuHoaX.second;
    buff_tx[33] = 0x00;   
    
    buff_tx[34] = timeThaoTacX.hour; 
    buff_tx[35] = 0x00;
    buff_tx[36] = timeThaoTacX.hour; 
    buff_tx[37] = 0x00;
    buff_tx[38] = timeThaoTacX.second;  
